...
[update based on teaam] 

```{r load_data}
### EDIT: You need to insert your dataset file names in the quotes below

exprs <- readRDS("C:/Users/RGoettl/Desktop/School/Fall 2019/BIFS 613/BIFS  613 Group Proj/TCGA-KICH_exprs.rds")
pheno <- readRDS("C:/Users/RGoettl/Desktop/School/Fall 2019/BIFS 613/BIFS  613 Group Proj/TCGA-KICH_pheno.rds")
```
...
[update based on prev] Remove samples with missing data (or no data; i.e. "not reported") for your "group". First from phenoData
...
rownames(exprs_mat) <- paste(pheno$sample,pheno$group, sep = " ")
```
...
```{r hc_gap}
set.seed(1234)
fviz_nbclust(exprs_mat, FUN = hcut, nboot = 25, method = "gap_stat")
...
res_clusters %>%
  ...
  mutate(
    ...
    cluster_4 = round(100*cluster_4/n_samples),
    cluster_5 = round(100*cluster_5/n_samples),
    cluster_6 = round(100*cluster_6/n_samples)
  ) %>%
